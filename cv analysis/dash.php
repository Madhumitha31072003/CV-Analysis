...
<div class="row">
<div class="col-lg-6">
<span class="logo">CV Prediction System</span></div>
<?php
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <li <?php if(@$_GET['q']==5) echo'class="active"'; ?>><a href="dash.php?q=5">Reply</a></li>
      </ul>
          </div><!-- /.navbar-collapse -->
  </div><!-- /.container-fluid -->
</nav>
...
echo  '<div class="panel"><table class="table table-striped title1">
<tr><td><b>S.N.</b></td><td><b>Name</b></td><td><b>Gender</b></td><td></td><td><b>Resume link</b></td><td><b>Email</b></td><td><b>Mobile</b></td><td></td></tr>';
$c=1;
while($row = mysqli_fetch_array($result)) {
	$name = $row['name'];
	$mob = $row['mob'];
	...
	echo '<tr><td>'.$c++.'</td><td>'.$name.'</td><td>'.$gender.'</td><td></td><td>'.$college.'</td><td>'.$email.'</td><td>'.$mob.'</td>
...
echo ' 
<div class="row">
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Enter Feedback Reply</b></span><br /><br />
 <div class="col-md-3"></div><div class="col-md-6">   <form class="form-horizontal title1" name="form" action="update.php?q=addquiz"  method="POST">
<fieldset>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="desc"></label>  
  <div class="col-md-12">
  <textarea rows="8" cols="8" name="desc" class="form-control" placeholder="Write feedback reply here..."></textarea>  
  </div>
</div>
