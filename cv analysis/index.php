...
<title>CV Prediction System</title>
...
<div class="form-group">
  <label class="col-md-12 control-label" for="name"></label>  
  <div class="col-md-12">
  <input id="college" name="college" placeholder="Resume Link" class="form-control input-md" type="text">
...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" placeholder="Mobile" class="form-control input-md" type="number">
...
<div class="form-group">
  <label class="col-md-12control-label" for="fname"></label>
  <div class="col-md-12">
    <input id="fname" name="fname" placeholder="cv file" class="form-control input-md" type="file">
